...
const fs = require("fs") // npm i fs
    ...
    if(!message.member.hasPermission("MANAGE_CHANNELS")) return message.channel.send("**You need `Manage Channels` permission**")
            ...
            1- ${prefix}setWlc style <text, image, embed>
            2- ${prefix}setWlc msg <message>
            3- ${prefix}setWlc channel <channel name> <- __(No need to tag the channel just write the channel name)__**`)
            }
